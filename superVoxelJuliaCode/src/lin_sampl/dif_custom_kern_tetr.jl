...
function set_tetr_dat_kern_deff(tetr_dat,d_tetr_dat
                            ,tetr_dat_out,d_tetr_dat_out
...
function ChainRulesCore.rrule(::typeof(call_set_tetr_dat_kern),tetr_dat,source_arr,control_points,sv_centers,num_base_samp_points,num_additional_samp_points,threads_point_info,blocks_point_info,pad_point_info)
        ...
        function call_test_kernel1_pullback(d_tetr_dat_out)
            ...
            @device_code_warntype @cuda threads = threads_point_info blocks = blocks_point_info set_tetr_dat_kern_deff(tetr_dat,d_tetr_dat
                                                        ,tetr_dat_out,d_tetr_dat_out
                                                        ,source_arr,d_source_arr
                                                        ,control_points,d_control_points
                                                        ,sv_centers,d_sv_centers
