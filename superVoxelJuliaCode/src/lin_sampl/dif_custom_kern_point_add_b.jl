...
function point_info_kern_deff_add_b(tetr_dat,d_tetr_dat
    ...
    Enzyme.autodiff_deferred(Enzyme.Reverse,point_info_kern_add_b, Const
...
function ChainRulesCore.rrule(::typeof(call_point_info_kern_add_b),tetr_dat,out_sampled_points,source_arr,control_points,sv_centers,num_base_samp_points,num_additional_samp_points,threads_point_info,blocks_point_info,pad_point_info)
        ...
        out_sampled_points = call_point_info_kern_add_b(tetr_dat,out_sampled_points,source_arr,control_points,sv_centers,num_base_samp_points,num_additional_samp_points,threads_point_info,blocks_point_info,pad_point_info)    #TODO unhash
        ...
        function call_test_kernel1_pullback(d_out_sampled_points)
            ...
            @device_code_warntype @cuda threads = threads_point_info blocks = blocks_point_info point_info_kern_deff_add_b(tetr_dat,d_tetr_dat
                                                        ,out_sampled_points,d_out_sampled_points
                                                        ,source_arr,d_source_arr
                                                        ,control_points,d_control_points
                                                        ,sv_centers,d_sv_centers
