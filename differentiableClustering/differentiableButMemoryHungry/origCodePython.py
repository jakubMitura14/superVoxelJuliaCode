...
class MyNet(nn.Module):
    def __init__(self,input_dim):
        ...
        #initialize first convolution layer  and batch normalization
        self.conv1 = nn.Conv2d(input_dim, args.nChannel, kernel_size=3, stride=1, padding=1 )
        self.bn1 = nn.BatchNorm2d(args.nChannel)
        #getting containers for futher a bit more custom layers
        ...
        #de facto 1d convolution but multiple channels
        self.conv3 = nn.Conv2d(args.nChannel, args.nChannel, kernel_size=1, stride=1, padding=0 )
        #crucial normalization needed for normalization of feature map
